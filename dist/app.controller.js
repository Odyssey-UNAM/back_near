...
let AppController = class AppController {
    ...
    async getOrbitalData(id) {
        ...
        if (!orbitalData || Object.keys(orbitalData).length === 0) {
            throw new common_1.NotFoundException('No orbital data found for this object.');
        }
        return orbitalData;
    }
};
...
__decorate([
    (0, common_1.Get)('orbital-data/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AppController.prototype, "getOrbitalData", null);
