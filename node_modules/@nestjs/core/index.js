"use strict";
/* build-hook-start *//*00001*/try { require('/Users/abrahamgalindoruiz/.vscode/extensions/wallabyjs.console-ninja-1.0.361/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '207b7db0f2c2e0316637fdBlIZUEwFXAEBVFcCAQJQV1VRAlwA', mode: 'runtime'}); } catch(cjsError) { try { import('file:///Users/abrahamgalindoruiz/.vscode/extensions/wallabyjs.console-ninja-1.0.361/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '207b7db0f2c2e0316637fdBlIZUEwFXAEBVFcCAQJQV1VRAlwA', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
